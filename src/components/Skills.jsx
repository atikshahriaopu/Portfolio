  ...
  const skillCategories = [
      ...
      icon: (
        <div className="relative">
          <svg className="w-12 h-12 sm:w-14 sm:h-14" viewBox="0 0 24 24" fill="none">
            <path d="M4 4L20 4L20 20L4 20L4 4Z" fill="url(#codeGradient)" opacity="0.2"/>
            <path d="M8 8L12 12L8 16M12 16L16 16" stroke="url(#codeGradient)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            <defs>
    ...
    },
    {
      ...
      icon: (
        <div className="relative">
          <svg className="w-12 h-12 sm:w-14 sm:h-14" viewBox="0 0 24 24" fill="none">
            <circle cx="12" cy="12" r="9" stroke="url(#frameworkGradient)" strokeWidth="2" opacity="0.3"/>
            <path d="M12 3C12 3 8 8 8 12C8 16 12 21 12 21C12 21 16 16 16 12C16 8 12 3 12 3Z" stroke="url(#frameworkGradient)" strokeWidth="2" fill="url(#frameworkGradient)" fillOpacity="0.2"/>
            <path d="M3 12C3 12 8 8 12 8C16 8 21 12 21 12C21 12 16 16 12 16C8 16 3 12 3 12Z" stroke="url(#frameworkGradient)" strokeWidth="2" fill="url(#frameworkGradient)" fillOpacity="0.2"/>
    ...
    },
    {
      ...
      icon: (
        <div className="relative">
          <svg className="w-12 h-12 sm:w-14 sm:h-14" viewBox="0 0 24 24" fill="none">
            <ellipse cx="12" cy="6" rx="8" ry="3" stroke="url(#dbGradient)" strokeWidth="2" fill="url(#dbGradient)" fillOpacity="0.2"/>
            <path d="M4 6V18C4 19.657 7.582 21 12 21C16.418 21 20 19.657 20 18V6" stroke="url(#dbGradient)" strokeWidth="2"/>
            <path d="M4 12C4 13.657 7.582 15 12 15C16.418 15 20 13.657 20 12" stroke="url(#dbGradient)" strokeWidth="2"/>
            <defs>
    ...
    },
    {
      ...
      icon: (
        <div className="relative">
          <svg className="w-12 h-12 sm:w-14 sm:h-14" viewBox="0 0 24 24" fill="none">
            <rect x="3" y="3" width="18" height="18" rx="2" stroke="url(#domainGradient)" strokeWidth="2" fill="url(#domainGradient)" fillOpacity="0.1"/>
            <path d="M9 9L12 12M12 12L15 9M12 12L9 15M12 12L15 15" stroke="url(#domainGradient)" strokeWidth="2" strokeLinecap="round"/>
    ...
    },
    {
      ...
      icon: (
        <div className="relative">
          <svg className="w-12 h-12 sm:w-14 sm:h-14" viewBox="0 0 24 24" fill="none">
            <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" stroke="url(#toolGradient)" strokeWidth="2" fill="url(#toolGradient)" fillOpacity="0.2"/>
            <defs>
